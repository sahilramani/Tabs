...
.PHONY: test run device archive export upload beta clean help
...
archive: ## Archive a signed Release build (stamps build number $(BUILD))
...
export: ## Export the archive to an App Store .ipa
